/*
    ...
    Explanation:
    When n = 3 then the minimum number that is divisible by all the number till 3 is 6.
    ...
    Explanation:
    When n = 4 then the minimum number that is divisible by all the number till 4 is 12.
